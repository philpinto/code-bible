    ...
    // Within the document, set an on click listener for the element with a class of "letterA"
        ...
        // When that element is clicked, append the string "A" to the `text-div` element's text content

        
    // Within the document, set an on click listener for the element with a class of "letterB"

    
        // When that element is clicked, append the string "B" to the `text-div` element's text content
