...
2. Clone this repository to your computer using the process in the homework-pt-1 git cheatsheet.
...
4. Commit often following the steps listed in the homework-pt-1 git cheatsheet.
