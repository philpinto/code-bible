...
const songs2 = [...songs, "Fergalicious"];
...
function addition(...array) {
  return array.reduce((prev, item) => prev + item, 0); // you don't have to change this line of code but look up reduce if you're not sure what it does here https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/reduce
}
