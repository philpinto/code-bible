...
const useUserModel = (startingName = "Bob", startingStatus = "Excited") => {
  const [nameState, setName] = useState(startingName);
  const [imageState, setImage] = useState(profileImage);
  const [statusState, setStatus] = useState(startingStatus);
