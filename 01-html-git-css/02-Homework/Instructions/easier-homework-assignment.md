...
* Please submit the links to the Github Repository and Pull Request as listed in the homework-pt-1 git-cheatsheet!

### Instructions

1. Create a new repository in GitHub called `HW-Wireframe`.
2. Clone this repository using the homework-pt-1 git cheatsheet.
...
4. Make commits often by following the steps listed in the homework-pt-1 git-cheatsheet.
...
6. When you finish the assignment, follow the homework-pt-1 git-cheatsheet for publishing the assignment.
